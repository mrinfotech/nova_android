 ...
 */
public class FinanceRejectedOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public FinanceRejectedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(FinanceRejectedOrdersFragment.this);
        edtxt_todate.setOnTouchListener(FinanceRejectedOrdersFragment.this);
...
//        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date,"Placed");
        Call<Order> mService = mApiService.getFinanceOrdersList(PRIMARYID, from_date, to_date,"Rejected",BRANCHID);
