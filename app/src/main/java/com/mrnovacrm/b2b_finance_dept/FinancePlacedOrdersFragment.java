 ...
 */
public class FinancePlacedOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public FinancePlacedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(FinancePlacedOrdersFragment.this);
        edtxt_todate.setOnTouchListener(FinancePlacedOrdersFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getFinanceOrdersList(PRIMARYID, from_date, to_date,"Ordered",BRANCHID);
        ...
        public void onBindViewHolder(MyViewHolder holder,final int position) {
            ...
            holder.viewbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getActivity(), FinancePlacedOrderDetailsActivity.class);
