...
//public class FinanceTransferredOrdersFragment {
//}
 ...
 */
public class FinanceTransferredOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public FinanceTransferredOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(FinanceTransferredOrdersFragment.this);
        edtxt_todate.setOnTouchListener(FinanceTransferredOrdersFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getFinanceTransferredOrdersList(PRIMARYID, from_date, to_date,"Approved",BRANCHID);
