...
public class EmployeeFullDeatailsActivity extends AppCompatActivity {
...
//                addresstxt.setText(DELIVERY_ADDRESS);
    ...
    private void getEMPListDetails() {
        final TransparentProgressDialog dialog = new TransparentProgressDialog(EmployeeFullDeatailsActivity.this);
        dialog.show();
