 ...
 */
public class FinanceApprovedOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public FinanceApprovedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(FinanceApprovedOrdersFragment.this);
        edtxt_todate.setOnTouchListener(FinanceApprovedOrdersFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getFinanceOrdersList(PRIMARYID, from_date, to_date,"Approved",BRANCHID);
        ...
        public void onBindViewHolder(MyViewHolder holder,final int position) {
            ...
            holder.viewbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("SCREENFROM","Approved");
