...
//public class UpdateEmployeesActivity {
//    
//    
//}
...
public class UpdateEmployeesActivity extends AppCompatActivity {
...
//                addresstxt.setText(DELIVERY_ADDRESS);
        ...
        {
            dealeridlinear.setVisibility(View.VISIBLE);
    ...
    private void getEMPListDetails() {
        final TransparentProgressDialog dialog = new TransparentProgressDialog(UpdateEmployeesActivity.this);
        dialog.show();
