 ...
 */
public class AdminApprovedOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public AdminApprovedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(AdminApprovedOrdersFragment.this);
        edtxt_todate.setOnTouchListener(AdminApprovedOrdersFragment.this);
    ...
    private void getOrdersList() {
        ...
        if(SHORTFORM.equals("SA")) {
            String BRANCH_ID=globalShare.getSelectedBranchid();
            mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date,"Approved",BRANCH_ID);
        }else{
            mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date,"Approved",BRANCHID);
        }
//        Call<Order> mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date,"Approved",BRANCHID);
