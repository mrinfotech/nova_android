 ...
 */
public class AdminMenuScreenActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle("Manage Finance Manager");
        ...
        if(globalShare.getAdminmenuselectpos()!=null)
        {
            String pos=globalShare.getAdminmenuselectpos();
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                mToolbar.setTitle("Manage Depot Manager");
//                fragment=new ManageFinanceManagerFragment();
                fragment = new ManageEmployeeDeatailsFragment();
                Bundle bundle = new Bundle();
                bundle.putString("fromval", "FM");
                bundle.putString("title", "Manage Depot Manager");
            ...
            case 3:
                ...
                break;
            case 4:
                mToolbar.setTitle("Manage Grade");
                fragment = new ManageGradesFragment();
                break;
           /* case 5:
                ...
                .setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                editor.clear();
                                editor.apply();
                                SharedDB.clearAuthentication(AdminMenuScreenActivity.this);
    ...
    protected AdminMenuScreenActivity.OnBackPressedListener onBackPressedListener;

    public interface OnBackPressedListener {
        void doBack();
    }

    public void setOnBackPressedListener(AdminMenuScreenActivity.OnBackPressedListener onBackPressedListener) {
...
//public class AdminMenuScreenActivity {
//}
...
//import com.nova.b2b_finance_dept.ManageEmployeeDeatailsFragment;
...
//               // fragment = new DispatchInvoiceListFragment();
//
//                Toast.makeText(getApplicationContext(),"Invoice called",Toast.LENGTH_SHORT).show();
//
//            case 4:
//                mToolbar.setTitle("Manage Grades");
//                fragment = new ManageGradesFragment();
//                break;
//            case 5:
//                mToolbar.setTitle("Change Password");
