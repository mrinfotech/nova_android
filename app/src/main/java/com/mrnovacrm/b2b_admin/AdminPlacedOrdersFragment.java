 ...
 */
public class AdminPlacedOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public AdminPlacedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(AdminPlacedOrdersFragment.this);
        edtxt_todate.setOnTouchListener(AdminPlacedOrdersFragment.this);
    ...
    private void getOrdersList() {
        ...
        if(SHORTFORM.equals("SA")) {
            ...
            mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date, "Ordered", BRANCH_ID);
        }else{
            mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date, "Ordered", BRANCHID);
        }
