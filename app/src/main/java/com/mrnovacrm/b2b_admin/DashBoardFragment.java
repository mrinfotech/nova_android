                ...
                if (isConnectedToInternet) {
                    try {
                        ...
                        if (Status.equals("Orders")) {
                            ...
                            Intent intent=new Intent(getActivity(),AdminPaymentsActivity.class);
                            intent.putExtra("BRANCH_ID", BRANCHIDVAL);
                            startActivity(intent);
                        } else if (Status.equals("Dispatchers")) {
                            //  Intent intent=new Intent(getActivity(),EmployeeDataListActivity.class);
                            Intent intent = new Intent(getActivity(), EmpListActivity.class);
