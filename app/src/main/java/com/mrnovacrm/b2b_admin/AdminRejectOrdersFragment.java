 ...
 */
public class AdminRejectOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public AdminRejectOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(AdminRejectOrdersFragment.this);
        edtxt_todate.setOnTouchListener(AdminRejectOrdersFragment.this);
...
//        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date,"Placed");
        ...
        if(SHORTFORM.equals("SA")) {
            ...
            mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date,"Rejected",BRANCH_ID);
        }else{
            mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date,"Rejected",BRANCHID);
        }
      //  Call<Order> mService = mApiService.getAdminOrdersList(PRIMARYID, from_date, to_date,"Rejected",BRANCHID);
