...
//public class DispatchTotallyRejectedHistoryFragment {
//}
...
public class DispatchTotallyRejectedHistoryFragment extends Fragment implements View.OnTouchListener {
...
//        text_nodata = rootView.findViewById(R.id.text_nodata);
        ...
        edtxt_fromdate.setOnTouchListener(DispatchTotallyRejectedHistoryFragment.this);
        edtxt_todate.setOnTouchListener(DispatchTotallyRejectedHistoryFragment.this);
    ...
    private void getOrdersList(String fromdate, String todate) {
        ...
        Call<DailyOrders> mService = mApiService.deliveryBoyRejectedHistory(fromdate, todate, "2",PRIMARYID,BRANCHID);
...
//                startActivity(intent);
                ...
                Intent intent = new Intent(getActivity(), DispatchRejectedHistoryDetailsActivity.class);
                intent.putExtra("id",id);
                intent.putExtra("fromval", "totalrejected");
