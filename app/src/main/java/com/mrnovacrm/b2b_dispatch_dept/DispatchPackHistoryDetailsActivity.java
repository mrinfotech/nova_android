...
public class DispatchPackHistoryDetailsActivity extends AppCompatActivity implements View.OnClickListener {
...
//        setTitle("Order Details");
       ...
       TextView packqtytxt = findViewById(R.id.packqtytxt);
        ...
        boolean isConnectedToInternet = CheckNetWork
                .isConnectedToInternet(DispatchPackHistoryDetailsActivity.this);
    ...
    private void getOrderListDetails() {
        final TransparentProgressDialog dialog = new TransparentProgressDialog(DispatchPackHistoryDetailsActivity.this);
        dialog.show();
        RetrofitAPI mApiService = SharedDB.getInterfaceService();
        Call<Order> mService = mApiService.getDipachPackerOrderDetails(ID,STATUSVALUE,SHORTFORM);
