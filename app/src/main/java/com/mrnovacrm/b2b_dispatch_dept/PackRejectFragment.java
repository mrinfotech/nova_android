...
public class PackRejectFragment extends Fragment implements View.OnTouchListener {
  ...
  //  TextView text_nodata;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // text_nodata = rootView.findViewById(R.id.text_nodata);
        ...
        edtxt_fromdate.setOnTouchListener(PackRejectFragment.this);
        edtxt_todate.setOnTouchListener(PackRejectFragment.this);
    ...
    public class SellerPlaceOrdersRecyclerAdapter extends RecyclerView.Adapter<SellerPlaceOrdersRecyclerAdapter.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), PackerPackReceiveDetails.class);
                intent.putExtra("id",id);
                intent.putExtra("fromval", "reject");
