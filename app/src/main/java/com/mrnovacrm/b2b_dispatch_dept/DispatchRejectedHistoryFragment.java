...
//public class DispatchRejectedHistoryFragment {
//}
...
public class DispatchRejectedHistoryFragment extends Fragment implements View.OnTouchListener {
...
//        text_nodata = rootView.findViewById(R.id.text_nodata);
        ...
        edtxt_fromdate.setOnTouchListener(DispatchRejectedHistoryFragment.this);
        edtxt_todate.setOnTouchListener(DispatchRejectedHistoryFragment.this);
    ...
    private void getOrdersList(String fromdate, String todate) {
        ...
        Call<DailyOrders> mService = mApiService.deliveryBoyRejectedHistory(fromdate, todate, "1",PRIMARYID,BRANCHID);
...
//                startActivity(intent);
                ...
                intent.putExtra("id",id);
                intent.putExtra("fromval", "partialrejected");
