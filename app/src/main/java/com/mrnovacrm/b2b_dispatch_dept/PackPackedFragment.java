...
public class PackPackedFragment extends Fragment implements View.OnTouchListener {
   ...
   // TextView text_nodata;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      //  text_nodata = rootView.findViewById(R.id.text_nodata);
        ...
        edtxt_fromdate.setOnTouchListener(PackPackedFragment.this);
        edtxt_todate.setOnTouchListener(PackPackedFragment.this);
    ...
    private void getOrdersList(String fromdate, String todate) {
        ...
        Call<DailyOrders> mService = mApiService.packerspackreport(fromdate, todate, "1",PRIMARYID,BRANCHID);
