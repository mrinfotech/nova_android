...
//public class PackRejectedFragment {
//}
...
public class PackRejectedFragment extends Fragment implements View.OnTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        edtxt_fromdate.setOnTouchListener(PackRejectedFragment.this);
        edtxt_todate.setOnTouchListener(PackRejectedFragment.this);
    ...
    private void getOrdersList(String fromdate, String todate) {
        ...
        Call<DailyOrders> mService = mApiService.packerspackreport(fromdate, todate, "2",PRIMARYID,BRANCHID);
                        ...
                        if (ordersList != null) {
                            if (ordersList.size() > 0) {
                                ...
                                for (int i = 0; i < ordersList.size(); i++) {
                                    ...
                                    String orderedon = ordersList.get(i).getPacked_date();
            ...
            public void onClick(View view) {
                ...
                if(isConnectedToInternet)
                {
                    try{
                        ...
                        Intent intent = new Intent(getActivity(), DispatchPackHistoryDetailsActivity.class);
                        intent.putExtra("id",id);
                        intent.putExtra("fromval", "rejected");
