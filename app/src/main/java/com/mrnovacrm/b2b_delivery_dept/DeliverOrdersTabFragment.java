...
public class DeliverOrdersTabFragment extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
      ...
      //  adapter.addFragment(new DeliverReceivedFragment(), getString(R.string.placed));
        adapter.addFragment(new DeliverDeliveredFragment(), getString(R.string.delivered));
        adapter.addFragment(new DeliveredRejectedFragmnet(), getString(R.string.rejected));
