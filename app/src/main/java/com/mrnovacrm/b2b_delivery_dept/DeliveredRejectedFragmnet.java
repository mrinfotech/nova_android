...
public class DeliveredRejectedFragmnet extends Fragment implements View.OnTouchListener {
   ...
   // TextView text_nodata;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // text_nodata = rootView.findViewById(R.id.text_nodata);
        ...
        edtxt_fromdate.setOnTouchListener(DeliveredRejectedFragmnet.this);
        edtxt_todate.setOnTouchListener(DeliveredRejectedFragmnet.this);
    ...
    private void getOrdersList(String fromdate, String todate) {
        ...
        Call<DailyOrders> mService = mApiService.deliveryBoyDeliverHistory(fromdate, todate, "2",PRIMARYID,BRANCHID);
