...
public class DeliverRejectedFragmnet extends Fragment implements View.OnTouchListener {
   ...
   // TextView text_nodata;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     //   text_nodata = rootView.findViewById(R.id.text_nodata);
        ...
        edtxt_fromdate.setOnTouchListener(DeliverRejectedFragmnet.this);
        edtxt_todate.setOnTouchListener(DeliverRejectedFragmnet.this);
    ...
    private void getDeliveryStoreOrderList(String FROMDATE,String TODATE) {
        ...
        Call<SellerDTO> mService = mApiService.getDeliveryPickupHistory(FROMDATE,TODATE,"2",PRIMARYID);
