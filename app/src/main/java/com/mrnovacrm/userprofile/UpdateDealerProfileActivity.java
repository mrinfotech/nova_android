...
//public class UpdateDealerProfileActivity {
//}
...
public class UpdateDealerProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backimg.setOnClickListener(UpdateDealerProfileActivity.this);

        Bundle bundle=getIntent().getExtras();
        IDVAL=bundle.getString("id");
        SHORTFROMVAL= bundle.getString("SHORTFROM");
        ...
        updatebtn.setOnClickListener(UpdateDealerProfileActivity.this);
...
//        Log.e("EMPLOYEE",PRIMARYID);
        ...
        Call<Login> mService = mApiService.updateDealer(
                ...
                PERSONALEMAIL,PRIMARYID,"DEALER",COMPANY_VAL,BRANCHID,LICENCENO,IDVAL);
                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        if(EmpListActivity.mainfinish!=null)
                        {
                            ...
                            intent.putExtra("shortform",SHORTFROMVAL);
    ...
    private void getEMPList_Details() {
        final TransparentProgressDialog dialog = new TransparentProgressDialog(UpdateDealerProfileActivity.this);
        dialog.show();
        RetrofitAPI mApiService = SharedDB.getInterfaceService();
