...
public class DealerScreenActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    private static DealerScreenActivity mInstance = null;
...
//                    Toast.makeText(getApplicationContext(), "Push notification: " + message, Toast.LENGTH_LONG).show();
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 4:
                // bank information
                mToolbar.setTitle("Bank Information");
                fragment = new DealerBankInformationFragment();
                ...
                .setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                editor.clear();
                                editor.commit();
                                SharedDB.clearAuthentication(DealerScreenActivity.this);
                                ...
                                if (SHORTFORM.equals("SE")) {
                                    ...
                                    dealereditor.clear();
                                    dealereditor.commit();
                                    SharedDB.dealerclearAuthentication(DealerScreenActivity.this);
                                }
                                refreshToken();
...
//                return true;
    ...
    public static void updateCartCountNotification(String count) {
        itemscount = count;
        DealerScreenActivity instance = DealerScreenActivity.getInstance();
        if (instance != null) {
            instance.getCartCount(count);
        }
    }

    private static synchronized DealerScreenActivity getInstance() {
        return mInstance;
    }
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(DealerScreenActivity.this, new String[]{Manifest.permission.CALL_PHONE}, CALL_REQUEST);
                        return;
                    }
                }
