...
//public class DealerRejectedOrdersFragment {
//}
 ...
 */
public class DealerRejectedOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public DealerRejectedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(DealerRejectedOrdersFragment.this);
        edtxt_todate.setOnTouchListener(DealerRejectedOrdersFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date,"Dispatch_Reject",SHORTFORM,BRANCHID);
...
//                Log.e("ID***", " :" + id);
//                Intent intent = new Intent(getActivity(), ReceivedOrdersDetailsActivity.class);
...
//                String status = ordersList.get(position).get("status");
              //  Log.e("ID***", " :" + id);
                ...
                intent.putExtra("orderId", orderId);
                intent.putExtra("status", status);
                intent.putExtra("SCREENFROM", "ReceiveReject");
                startActivity(intent);
            }
        }
    }
