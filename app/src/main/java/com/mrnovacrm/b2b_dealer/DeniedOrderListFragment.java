...
//public class DeniedOrderListFragment {
//}
 ...
 */
public class DeniedOrderListFragment extends Fragment implements View.OnTouchListener {
    ...
    public DeniedOrderListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(DeniedOrderListFragment.this);
        edtxt_todate.setOnTouchListener(DeniedOrderListFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date,"Denied",SHORTFORM,BRANCHID);
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.viewbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("SCREENFROM","Denied");
