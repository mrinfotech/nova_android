...
//public class DeliveryOrderDetailsActivity {
//}
...
public class DeliveryOrderDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView subtotalamounbt_txt,ordertakenbytitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backimg.setOnClickListener(DeliveryOrderDetailsActivity.this);
...
//        order_key = getIntent().getStringExtra("order_key");
        ...
        btn_cancel.setOnClickListener(DeliveryOrderDetailsActivity.this);
    ...
    public void showCancelOrderPopup() {
        ...
        alertDialog = new Dialog(DeliveryOrderDetailsActivity.this);
        ...
        closeicon.setOnClickListener(DeliveryOrderDetailsActivity.this);
        submittxt.setOnClickListener(DeliveryOrderDetailsActivity.this);
    ...
    private void cancelOrder(String reason) {
        final TransparentProgressDialog dialog = new TransparentProgressDialog(DeliveryOrderDetailsActivity.this);
        dialog.show();
