...
//public class ReceivedOrdersFragment {
//}
 ...
 */
public class ReceivedOrdersFragment extends Fragment implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(ReceivedOrdersFragment.this);
        edtxt_todate.setOnTouchListener(ReceivedOrdersFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date,"Received",SHORTFORM,BRANCHID);
