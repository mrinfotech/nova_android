 ...
 */
public class CancelHistoryFragment extends Fragment implements View.OnTouchListener {
   ...
   // TextView text_nodata;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(CancelHistoryFragment.this);
        edtxt_todate.setOnTouchListener(CancelHistoryFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date,"Cancelled",SHORTFORM,BRANCHID);
        ...
        public void onBindViewHolder(MyViewHolder holder,final int position) {
            ...
            holder.viewbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("SCREENFROM","Canceled");
