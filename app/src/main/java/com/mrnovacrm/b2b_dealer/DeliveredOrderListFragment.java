...
//public class DeliveredOrderListFragment {
//}

//package com.bulktrade.bt_user;


//public class PendingListFragment {
//}
 ...
 */
public class DeliveredOrderListFragment extends Fragment implements View.OnTouchListener {
    ...
    public DeliveredOrderListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(DeliveredOrderListFragment.this);
        edtxt_todate.setOnTouchListener(DeliveredOrderListFragment.this);
            ...
            holder.viewbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   // Intent intent = new Intent(getActivity(), OrderDetailsActivity.class);
                    Intent intent = new Intent(getActivity(), DeliveryOrderDetailsActivity.class);
