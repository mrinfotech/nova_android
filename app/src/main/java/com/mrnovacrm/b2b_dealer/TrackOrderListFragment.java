...
public class TrackOrderListFragment extends Fragment implements View.OnTouchListener, View.OnClickListener {
   ...
   // TextView text_nodata;
    ...
    //    text_nodata = rootView.findViewById(R.id.text_nodata);
        ...
        viewreport_btn.setOnClickListener(TrackOrderListFragment.this);
        ...
        edtxt_fromdate.setOnTouchListener(TrackOrderListFragment.this);
        edtxt_todate.setOnTouchListener(TrackOrderListFragment.this);
