...
//public class RejectedOrderListFragment {
//}
 ...
 */
public class RejectedOrderListFragment extends Fragment implements View.OnTouchListener {
    ...
    public RejectedOrderListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(RejectedOrderListFragment.this);
        edtxt_todate.setOnTouchListener(RejectedOrderListFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date,"rejected",SHORTFORM,BRANCHID);
                        ...
                        if (ordersList != null) {
                            if (ordersList.size() > 0) {
                                ...
                                for (int i = 0; i < ordersList.size(); i++) {
                                    ...
                                    String parent_order = ordersList.get(i).getParent_order();
                                    ...
                                    hashMap.put("parent_order", parent_order);
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            String parent_order = ordersList.get(position).get("parent_order");

            if(parent_order.equals("0"))
            {
                holder.ordertakenbytitle.setText("Order taken by");
            }else{
                holder.ordertakenbytitle.setText("Order transferred by");
            }
            ...
            holder.viewbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.e("ID***", " :" + id);
                    Intent intent = new Intent(getActivity(), RejectedOrderDetailsActivity.class);
                    intent.putExtra("id", id);
                    intent.putExtra("orderId", orderId);
                    intent.putExtra("status", status);
                    intent.putExtra("SCREENFROM","Rejected");
        ...
        class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            TextView ordertakenbytitle,orderid, orderedOn,creditdate,paymenttype,ordertakenby,dealer;
            Button viewbtn;
            LinearLayout dealaerlinear;

            MyViewHolder(View view) {
                super(view);
                ordertakenbytitle = view.findViewById(R.id.ordertakenbytitle);
