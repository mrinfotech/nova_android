...
public class OfferDealsFragment extends Fragment {
   ...
   //     imgrel=rootView.findViewById(R.id.imgrel);
    ...
    private void getProductsList() {
        ...
        Call<Product> mService = mApiService.getOffersList(PRIMARYID,"offer");
...
//                    startActivity(intent);
        ...
        class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            TextView product_name, product_mrp, product_pay, product_discount, product_margin, product_instock,packqtytxt,caserate_txt;
            Button bt_btn;
