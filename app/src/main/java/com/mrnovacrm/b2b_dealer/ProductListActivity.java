...
public class ProductListActivity extends AppCompatActivity {
    ...
    private static ProductListActivity mInstance = null;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewpager_subcategory);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        if (getIntent() != null) {
            subcatIdList = getIntent().getStringArrayListExtra("subcatId");
            subcatNameList = getIntent().getStringArrayListExtra("subcatName");
    ...
    public static void updateCartCountNotification(String count) {
        itemscount = count;
        ProductListActivity instance = ProductListActivity.getInstance();
        if (instance != null) {
...
//        }
 ...
 //       Call<Product> mService = mApiService.getCartCount(PRIMARYID);
    ...
    private static synchronized ProductListActivity getInstance() {
        return mInstance;
    }
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(ProductListActivity.this, new String[]{Manifest.permission.CALL_PHONE}, CALL_REQUEST);
                        return;
                    }
                }
