 ...
 */
public class OrderListFragment extends Fragment implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtxt_fromdate.setOnTouchListener(OrderListFragment.this);
        edtxt_todate.setOnTouchListener(OrderListFragment.this);
    ...
    private void getOrdersList() {
        ...
        Call<Order> mService = mApiService.getOrdersList(PRIMARYID, from_date, to_date, "Placed", SHORTFORM,BRANCHID);
